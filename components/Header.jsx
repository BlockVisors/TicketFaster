            ...
            <Link href="/">
                <div className="flex flex-row items-center justify-center p-0 gap-[10px]">
                    <div className="relative flex items-center justify-center">
                        <img src={Logo.src} height="35px" alt="Ticket-Faster" />
                        <img src={LogoGlow.src} className="absolute h-[85px] w-[85px] max-w-[85px]" alt="Ticket-Faster" />
                    </div>
                    <div className="flex flex-col items-start p-0 ">
                        <p className="secondaryFont text-2xl font-bold leading-5 text-white">Ticketfaster</p>
                        <p className="PrimaryFont text-xs font-extralight leading-5 tracking-widest text-white">NFT ticketing solution</p>
                    </div>
                </div>
            </Link>
